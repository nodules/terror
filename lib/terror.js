...
function Terror(code, message) {
    ...
    stack.splice(0, 2);
    stack.unshift(this.constructor.name);
 ...
 * Throws TerrorError if collision detected.
 ...
 * @returns {Function} constructor
 */
Terror.removeDefaultLogger = function() {
    this.prototype.logger = null;

    return this;
};

Terror.prototype.loggers = [];

/**
 * @param {Function} logger (String message, String errorLevel)
 * @returns {Function} constructor
 */
Terror.addLogger = function(logger) {
    this.prototype.loggers.push(logger);
    return this;
};
...
Terror.prototype.log = function(level) {
    var isLogger = typeof this.loggers !== "undefined" && this.loggers instanceof Array;
    if (this._isLogged || ! this.logger && !isLogger) {
        return this;
    }
    ...
    //defult logger
    this.logger && this.logger(message, level);
    //custom loggers
